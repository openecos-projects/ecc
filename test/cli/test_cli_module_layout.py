...
def test_core_old_paths_reexport_owner_modules():
    for old_name, new_name, symbol in (
        ("command_inputs", "core.inputs", "OutputOptions"),
        ("invocation", "core.invocation", "execute_command"),
        ("options", "core.options", "JsonOption"),
        ("output", "core.output", "disclosure_cmd"),
        ("records", "core.records", "error_record"),
        ("types", "core.types", "CommandResult"),
    ):
...
def test_command_registration_old_paths_reexport_command_symbols():
    for old_name, new_name, symbol in (
        ("project_app", "project", "register_project_commands"),
