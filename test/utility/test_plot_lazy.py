...
def test_utility_import_does_not_load_matplotlib():
    result = _run_fresh("import sys, chipcompiler.utility; print('matplotlib' in sys.modules)")
...
def test_plot_exports_resolve_lazily():
    result = _run_fresh(
