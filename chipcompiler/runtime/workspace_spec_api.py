...
class WorkspaceSpecRuntimeMixin:
    ...
    def open_workspace(
        ...
        from chipcompiler.runtime.workspace_api import _workspace_ownership_lock

        with _workspace_ownership_lock(Path(request.directory)):
            return self._open_workspace_unlocked(request)

    def _open_workspace_unlocked(
        self,
        request: WorkspaceOpenRequest | WorkspaceSpecOpenRequest,
    ) -> dict:
