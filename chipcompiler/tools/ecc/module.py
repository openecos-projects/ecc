...
class ECCToolsModule:
    ...
    def __init__(self):
        try:
            ...
            raise ImportError("ecc tool is not installed or not found.") from err
    ...
    def feature_cts_map(self, json_path: str, map_grid_size=1):
        """
    ...
    # STA api
    ########################################################################
    def init_sta(self, output_dir: str, design: str, lib_paths: list[str], sdc_path: str):
