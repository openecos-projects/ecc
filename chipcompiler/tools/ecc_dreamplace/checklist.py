...
class DreamplaceChecklist:
    ...
    def metrics(self) -> dict:
        return json_read(self.workspace_step.analysis.metrics or "")
    ...
    def has_plot_files(self) -> bool:
        step_dirs = self.workspace_step.data.steps
...
class DreamplacePlacementChecklist(DreamplaceChecklist):
    ...
    def hpwl_success(self) -> bool:
        ...
        return hpwl is not None and hpwl > 0 and final_hpwl is not None and final_hpwl > 0
    ...
    def check(self) -> bool:
        checks = [
            ...
            (
                ...
                "check HPWL",
                self.hpwl_success(),
                "HPWL metric or final PPA hpwl is missing",
                True,
            ),
            (
                "Legality",
            ...
            (
                ...
                self.congestion_success(),
                "congestion metrics or placement plot files are missing",
                True,
            ),
        ]
